...
export const taglines = [
    "Coding software that I'm passionate about, since 2020",
    "Full time developer, part time JRPG geek",
    '"A soul in tension that\'s learning to fly, condition grounded but determined to try"',
    "Rochester Institute of Technology alumni. Go Tigers!",
];
...
export const jobs = [
    {
        ...
        desc: "Engineered core Laravel functionalities including web page redirection, image uploads, and automated PDF workflows using PDFKit, JavaScript, and Python. Developed accessibility features for the PDF rendering engine, enabling logical document structures for visually impaired users and integrated ChartJS for dynamic chart generation in PDF templates.",
        logo: "more_vang.png",
    },
    {
    ...
    },
    {
        ...
        desc: "Facilitated weekly study sessions for historically difficult CS courses, designing coding assessments and lecture materials in Python, Java, and C. Graded and evaluated 100+ assignments weekly for CS1 and CS2 courses, with topics ranging from multithreaded programming with Python to memory-management with C. Provided detailed technical feedback on memory usage, runtime optimization, code structure, and documentation to help students improve their programming practices.",
        logo: "rit.png",
    },
];
...
export const projects = [
    ...
    },
    {
        ...
        desc: "A custom database system built from scratch in C as a collaborative group project. Implemented core SQL operations (INSERT, DELETE, SELECT) with complex subquery support, designed the page splitting mechanism and buffer system for efficient memory-to-disk operations, and handled low-level binary I/O for data persistence. Developed B+ tree insertion algorithms for query optimization and contributed to both the DDL and DML parsers, ensuring robust memory management through extensive debugging with GDB.",
        link: "",
        view: "cdb_demo.gif",
    },
    {
